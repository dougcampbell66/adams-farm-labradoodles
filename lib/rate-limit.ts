...
// addresses in ADAMS_FARM_ALLOWED_EMAILS can ever receive mail, so the
...
/**
 * Per-address rules. The 60-second cooldown defuses the common "mashed the
 * button" case; the hourly cap backstops a slow, sustained loop.
 */
 ...
 * spammer extend the lockout indefinitely — turning a rate limit into a
