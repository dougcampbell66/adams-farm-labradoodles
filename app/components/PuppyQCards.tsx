...
const phases: Phase[] = [
  {
    ...
    accent: "var(--color-focus-green)",
    badgeText: "var(--color-white)",
    phaseText: "var(--color-focus-green)",
    backText: "var(--color-white)",
  },
  {
    n: 2,
    ...
    accent: "var(--color-calm-blue)",
    badgeText: "var(--color-white)",
    phaseText: "var(--color-calm-blue)",
    backText: "var(--color-white)",
  },
  {
    n: 3,
    ...
    accent: "var(--color-excite-yellow)",
    badgeText: "var(--color-navy)",
    phaseText: "var(--color-excite-yellow-dark)",
    backText: "var(--color-navy)",
  },
  {
    n: 4,
    ...
    accent: "var(--color-feelings-red)",
    badgeText: "var(--color-white)",
    phaseText: "var(--color-feelings-red)",
    backText: "var(--color-white)",
  },
];
